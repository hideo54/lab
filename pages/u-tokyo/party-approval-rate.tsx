    ...
    return (
        ...
        >
            ...
            <ul>
                ...
                <li>特に、<strong>2020年以降のデータを見るにあたっては注意が必要です</strong>。本調査は2019年までは、新入生が入学手続きを行う集まりの際に実施されており、<strong>新入生約3,000人のほぼ全員が回答する、非常に意義深い調査でした</strong>。しかし、<strong>2020年以降、新型コロナウイルス流行を機にオンライン化され、回答者数は数百人 (新入生の1, 2割程度) と激減しており</strong>、母集団は「この調査にわざわざ回答する人」というバイアスがかかったものとなっています。</li>
            </ul>
            <h2>ソース</h2>
            <ul>
